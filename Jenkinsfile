...
def version
def sumo_repository = 'coffeebartest/the-coffee-bar'
def arun_repository = 'coffeebartestarun/the-coffee-bar-arun'
// def sumo_ecr_registry = "https://681285326029.dkr.ecr.us-west-2.amazonaws.com" // iahuja
// def arun_ecr_registry = "https://681285326029.dkr.ecr.us-west-2.amazonaws.com" // iahuja

def sumo_ecr_registry = 'https://246946804217.dkr.ecr.us-west-2.amazonaws.com' // infrastructure
def arun_ecr_registry = 'https://246946804217.dkr.ecr.us-west-2.amazonaws.com' // infrastructure
      ...
      steps {
        script {
          docker.withRegistry(sumo_ecr_registry) {
            // withAwsCredentialsFor('infrastructure') { // withAwsCredentialsFor("iahuja") {
