...
def main():
    ...
    parser.add_argument('-ci', '--interval-based-cron', type=str, help='Use interval trigger in addition to CRON. - true/false')
    parser.add_argument('-sd', '--spike-interval-days', type=str, help='How many days to skip?')
